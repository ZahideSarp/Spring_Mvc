...
public class StudentController {
    ...
    @GetMapping("/hi")//("/hi") yazmazsak class mapping calisinca bu methodda calısır
...
//    }
    ...
    public ModelAndView listAllStudents(){
        ...
        ModelAndView mav=new ModelAndView();
        mav.addObject("studentList",students);//studentForm'da student model'ina bulanan ogrenciyibind etme
