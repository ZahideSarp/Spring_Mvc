...
@EnableWebMvc//MVC icin config etkinlestirmek
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    //css,image statik olan kaynaklarin dispatchera gonderilmesine gerek yok
  //ex:  http://localhost:8080/SpringMvc/resources/css/style.css
   @Override
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        registry.addResourceHandler("/resources/**").//bu pathdeki kaynakları static olarak sun
